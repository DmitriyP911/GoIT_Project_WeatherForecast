...
const mainPageImg = document.querySelector( `.main-city-weather__img` );
...
export default function mainPageWeatherInfo ( parseData ) {
  ...
  mainPageImg.src = `http://openweathermap.org/img/wn/${parseData.list[0].forecast[0].weather[0].icon}@2x.png`
